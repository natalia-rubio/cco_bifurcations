...
print(f"Angle 1: {np.arccos(np.linalg.norm(inlet_ref1)/np.linalg.norm(contour1[-1,:]))}")
print(f"Angle 1: {angle1}")
new_angle1 = angle1 + np.pi/4
...
print(f"Angle 2: {np.arccos(np.linalg.norm(inlet_ref2)/np.linalg.norm(contour2[-1,:]))}")
