...
flow_amp = "half"
pdb.set_trace()
reader_0d_standard = read_geo(f"trees/zerod_output_cent_standard/{tree_name}/centerline_sol_{flow_amp}.vtp").GetOutput()
reader_0d_TP = read_geo(f"trees/zerod_output_cent_TP/{tree_name}/centerline_sol_{flow_amp}.vtp").GetOutput()
