...
array = n2v(pressure_error_rri)
array.SetName("rri_pressure_error")
array.SetNumberOfValues(reader_3d.GetNumberOfPoints())
reader_3d.GetPointData().AddArray(array) 

array = n2v(flow_error_rri)
array.SetName("rri_flow_error")
array.SetNumberOfValues(reader_3d.GetNumberOfPoints())
reader_3d.GetPointData().AddArray(array) 
...
write_geo(f"trees/threed_output_cent/{tree_name}/centerline_sol_aug.vtp", reader_3d)
