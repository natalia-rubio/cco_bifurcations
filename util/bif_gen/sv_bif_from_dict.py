...
for geo_index in range(len(junction_dict.keys())):
    junction_name = junction_names[geo_index]
    inlet_flow_list = []
    res1_list = []
    res2_list = []
    ...
    geo_params={"daughter1_angle": junction_dict[junction_name]["3D_junc_outlet1_angle"],
                ...
                "len1": junction_dict[junction_name]["3D_branch1_length"] + junction_dict[junction_name]["0D_length1_base"],
                "len2": junction_dict[junction_name]["3D_branch2_length"] + junction_dict[junction_name]["0D_length2_base"],
                "geo_dir": geo_dir,
                #"flow_split": junction_dict[junction_name]["0D_geo_flow_split"],
