...
def plot_centerline_values(tree_name):
    ...
    ax[1].plot(branch_dict[2]["path"], branch_dict[2]["flow"]+branch_dict[1]["flow"][0:branch_dict[2]["flow"].size], "--", color="black", label="Total Flow")
...
plot_centerline_values("CCO_020_97824")
