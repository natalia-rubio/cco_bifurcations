...
if __name__ == "__main__":
   ...
   inlet_cap = "inflow.vtp"
   caps.remove(inlet_cap)
   outlet_caps = caps
   ...
   tree_dict = {"tree_name": tree_name, 
               ...
               "dt": 0.1,
               "inflow": inflow}
   print(f"Creating 0D input file for {tree_name} with inflow {inflow}")
   write_standard0d_input_generator_file(tree_dict)
   print("Running SimVascular to generate 0D input file")
