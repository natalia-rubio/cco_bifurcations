...
def get_RRI_values(areas, tangents):
    ...
    R_lin1 = R_lin_star_pred1 *  A_char * U_char
    R_lin2 = R_lin_star_pred2 *  A_char * U_char
    R_quad1 = R_quad_star_pred1 * jnp.square(A_char * U_char)
    R_quad2 = R_quad_star_pred2 * jnp.square(A_char * U_char)
    L = [0, 0]
