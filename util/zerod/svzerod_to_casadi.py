...
if __name__ == "__main__":
    ...
    for i in range(num_iters):
        if i == 0:
            sol_dict = solve_casadi(tree_name, "standard", sol_prev = None, coef_factor=1) # coef_factor = i/num_iters)
        else:
            sol_dict = solve_casadi(tree_name, junction_mode, sol_prev = sol_dict, coef_factor = i/num_iters)
