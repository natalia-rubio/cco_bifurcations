...
def export_time_series_offsets(geo_name, anatomy, set_type, num_time_steps, inc):
    ...
    for percent_offset in offset_list:
        ...
        results_dir = f"/scratch/users/nrubio/synthetic_junctions_reduced_results/{anatomy}/{set_type}/{geo_name}/flow_unsteady_offset_{int(percent_offset*100)}_red_sol"
