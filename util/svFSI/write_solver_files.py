...
python3 /home/users/nrubio/SV_scripts/svFSI/check_convergence.py {geo_name} {flow_index} {anatomy} {set_type} {num_time_steps}\n\
"
...
def write_svfsi(anatomy, set_type, geo, flow_index, flow_params, cap_numbers, inlet_cap_number, num_time_steps, time_step_size):
    ...
    \n\
    <Add_face name='walls'>\n\
        <Face_file_path> {geo_dir}/mesh-complete/walls_combined.vtp\n\ </Face_file_path>\n\
    </Add_face>\n\
    \n\
    </Add_mesh>\n\
    \n\
