...
def extract_characteristic_values(tree_name):
    ...
    for model in models:
        ...
        pt_id, num_pts, branch_id, junction_id, area, angle1, angle2, angle3, path, pressure_in_time_half, flow_in_time_half, times, time_interval = \
        ...
        pt_id, num_pts, branch_id, junction_id, area, angle1, angle2, angle3, path, pressure_in_time_full, flow_in_time_full, times, time_interval = \
