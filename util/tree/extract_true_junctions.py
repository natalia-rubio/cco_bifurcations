...
if __name__ == "__main__":
    ...
    for isol_set_name in isol_set_list:
        ...
        add_3D_isol_values(junction_dict_master, tree_name, isol_set_name)
    plot_flow_splits(junction_dict_master, tree_name, flow_mag_list, time_step)
    make_pdfs(junction_dict_master, tree_name, flow_mag_list=flow_mag_list, time_step=time_step1, isol_set_list = isol_set_list)
